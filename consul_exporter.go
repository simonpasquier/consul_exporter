...
func main() {
	...
	kingpin.Flag("consul.request-limit", "Limit the maximum number of concurrent requests to the Consul API, 0 means no limit.").Default("0").IntVar(&opts.requestLimit)
